...
function caps_widgets_init() {	
	...
	register_sidebar( array(
		'name' => __( 'Product  Sidebar', THEMENAME ),
		'id' => 'sidebar-product',
		'description' => __( 'Appears only when woocommerce installed and sidebar selected in theme option.', THEMENAME ),
		'before_widget' => '<div id="%1$s" class="widget %2$s front-page-sidebar">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="title"><span>',
		'after_title' => '</span></h3>',
	...
	register_sidebar( array(
		'name' => __( 'Header Widget Area', THEMENAME ),
		'id' => 'footer-3',
		'description' => __( 'Appears above content area', THEMENAME ),
