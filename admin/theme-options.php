...
(16px X 16px)',
      ...
      array(
        'id'          => 'home_icon_display',
        'label'       => 'Home icon display in menu',
        'desc'        => '',
        'std'         => 'on',
        'type'        => 'on-off',
        'section'     => 'header_options',
      ...
      array(
        'id'          => 'placeholder_text',
        'label'       => 'Placeholder text in search',
        'desc'        => '',
        'std'         => 'Start typing...',
        'type'        => 'text',
        'section'     => 'header_options',
    ...
    array(
      ...
      array(
        'id'          => 'product_sidebar',
        'label'       => 'Display product sidebar in woocommerce page.',
        'desc'        => '',
        'std'         => 'rs',
        'type'        => 'select',
        'section'     => 'sidebar_options',
      ...
      array(
        'id'          => 'large_category_display',
        'label'       => 'Large box category display type',
        'desc'        => 'Display category on image.',
        'std'         => 'vertical',
        'type'        => 'select',
        'section'     => 'blog_options',
        'rows'        => '',
      ...
      array(
        ...
        'label'       => 'Large box excerpt length',
      ...
      array(
        ...
        'std'         => array(
                            array(
                              'title' => 'Facebook',
                              'link'  => 'https://www.facebook.com/themecap',
                              'icon'  => 'fa-facebook'
                              ),
                            array(
                              'title' => 'Twitter',
                              'link'  => 'http://twitter.com/themecap',
                              'icon'  => 'fa-twitter'
                              ),
                            array(
                              'title' => 'Skype',
