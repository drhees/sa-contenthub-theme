...
function caps_breadcrumbs() {
  ...
  if (is_home() || is_front_page()) {
    ...
    if ($showOnHome == 1) echo '<ul class="list-inline breadcrumb-list"><li><a href="' . $homeLink . '">' . $home . '</a></li></ul>';
  
  } else {
  
    echo '<ul class="list-inline breadcrumb-list"><li><a href="' . $homeLink . '">' . $home . '</a>' . $delimiter . '</li>';
